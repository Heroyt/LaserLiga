...
Route::group('/game')
     ...
     ->get('/{code}/player/{id}', [Games::class, 'playerResults'])
     ->get('/{code}/player/{id}/distribution/{param}', [DistributionController::class, 'distribution'])
     ->get('/{code}/player/{id}/elo', [Games::class, 'eloInfo'])
     ->get('/{code}/team/{id}', [Games::class, 'teamResults'])
